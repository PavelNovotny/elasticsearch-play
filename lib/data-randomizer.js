...
exports.randomizeAddress = function randomizeAddress() {
    return {
        "id":addressId++,
...
exports.randomizeCustomer = function randomizeCustomer() {
    return {
        "id" : customerId++,
...
exports.randomizeCustomerAccount = function randomizeCustomerAccount() {
    return {
...
exports.randomizeSubject = function randomizeSubject() {
    return {
        "id": subjectId++,
